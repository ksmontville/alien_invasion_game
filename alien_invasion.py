...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Create Ship, Bullet, and Alien instances for use within the game.
        self.ship = Ship(self)
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            # Create a new fleet and center the shio
            self._create_fleet()
            self.ship.center_ship()

            # Pause to allow player to respond to new game state
            sleep(1.0)
        else:
